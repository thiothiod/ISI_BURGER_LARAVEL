...
<head>
    ...
    <title>Nouveau Burger - ISI BURGER</title>
...
<body>
    ...
    <div class="container">
        <h2 class="fw-bold mb-4">➕ Nouveau Burger</h2>
                        ...
                        <form method="POST"
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-danger px-4">
                                    <i class="fas fa-save me-2"></i>Créer le burger
                                </button>
